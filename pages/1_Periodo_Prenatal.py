...
st.set_page_config(
    layout="wide",
    page_title="Prenatal - Red San Pablo",
    page_icon="🏥",
...
.no-data-title { font-family: 'Inter', sans-serif; font-size: 1.4rem; font-weight: 600; color: #64748b; }
...
/* Empujar contenido principal para compensar el topbar fijo */
...
<div class="topbar-sp">
    <div class="topbar-sp-left">
        ...
        <div>
            ...
            <div class="topbar-sp-sub">Curso de Vida &nbsp;·&nbsp; Perido Prenatal</div>
        </div>
    </div>
...
with st.sidebar:
    ...
    st.markdown(
        ...
        'RED SAN PABLO · PRENATAL XX-XX AÑOS<br>© César Malca - 2026</p>',
        unsafe_allow_html=True
    )
...
<div class="hero-header">
    ...
    <h1 class="hero-title">SEGUIMIENTO DE PAQUETE <span>PERIODO PRENATAL</span></h1>
    <p class="hero-sub">Población objetivo: XX – XX años · 30 indicadores evaluados</p>
</div>
...
df_base = df_base.filter(
    (pl.col("Anio_Actual_Paciente") >= 18) & (pl.col("Anio_Actual_Paciente") <= 29)
)
if sel_ipress:
