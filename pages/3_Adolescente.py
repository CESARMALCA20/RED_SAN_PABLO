...
st.set_page_config(
    layout="wide",
    page_title="Adolescente - Red San Pablo",
    page_icon="🏥",
...
<div class="topbar-sp">
    <div class="topbar-sp-left">
        ...
        <div>
            ...
            <div class="topbar-sp-sub">Curso de Vida &nbsp;·&nbsp; Adolescene</div>
        </div>
    </div>
...
with st.sidebar:
    ...
    st.markdown(
        ...
        'RED SAN PABLO · ADOLESCENTE 12-17 AÑOS<br>© César Malca - 2026</p>',
        unsafe_allow_html=True
    )
...
<div class="hero-header">
    ...
    <h1 class="hero-title">SEGUIMIENTO DE PAQUETE <span>ADOLESCENTE</span></h1>
    <p class="hero-sub">Población objetivo: 12 – 17 años · 30 indicadores evaluados</p>
</div>
...
df_base = df_base.filter(
    (pl.col("Anio_Actual_Paciente") >= 12) & (pl.col("Anio_Actual_Paciente") <= 17)
)
if sel_ipress:
