...
st.set_page_config(
    layout="wide",
    page_title="Joven - Red San Pablo",
    page_icon="🏥",
...
<div class="topbar-sp">
    <div class="topbar-sp-left">
        ...
        <div>
            ...
            <div class="topbar-sp-sub">Curso de Vida &nbsp;·&nbsp; Joven</div>
        </div>
    </div>
...
with st.sidebar:
    ...
    st.markdown(
        ...
        'RED SAN PABLO · JOVEN 18-29 AÑOS<br>© César Malca - 2026</p>',
        unsafe_allow_html=True
    )
...
<div class="hero-header">
    ...
    <h1 class="hero-title">SEGUIMIENTO DE PAQUETE <span>JOVEN</span></h1>
    <p class="hero-sub">Población objetivo: 18 – 29 años · 30 indicadores evaluados</p>
</div>
