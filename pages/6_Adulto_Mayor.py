...
st.set_page_config(
    layout="wide",
    page_title="Adulto Mayor - Red San Pablo",
    page_icon="🏥",
...
<div class="topbar-sp">
    <div class="topbar-sp-left">
        ...
        <div>
            ...
            <div class="topbar-sp-sub">Curso de vida &nbsp;·&nbsp; Adulto Mayor</div>
        </div>
    </div>
...
with st.sidebar:
    ...
    st.markdown(
        ...
        'RED SAN PABLO · ADULTO MAYOR<br>© César Malca - 2026</p>',
        unsafe_allow_html=True
    )
...
<div class="hero-header">
    ...
    <h1 class="hero-title">SEGUIMIENTO DE PAQUETE <span>ADULTO MAYOR</span></h1>
    <p class="hero-sub">Población objetivo: 60 a mas años · 31 indicadores evaluados</p>
</div>
...
df_base = df_base.filter(
    pl.col("Anio_Actual_Paciente") >= 60
)
if sel_ipress:
